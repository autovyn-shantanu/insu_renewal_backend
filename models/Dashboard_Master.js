...
const _DashboardMaster = function (sequelize, DataTypes) {
  return sequelize.define('DashboardMaster', {
    UTD: {
      autoIncrement: true,
...
const dashboardMasterSchema = Joi.object({
...
module.exports = { _DashboardMaster, dashboardMasterSchema };

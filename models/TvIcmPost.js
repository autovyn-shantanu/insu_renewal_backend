...
const _TV_ICM_Post = function (sequelize, DataTypes) {
  return sequelize.define(
    ...
    {
      sequelize,
      tableName: "TV_ICM_Post",
      schema: "dbo",
      timestamps: false,
      indexes: [
        {
          name: "PK__TV_ICM_Post",
          unique: true,
...
const TVICMPostSchema = Joi.object({
...
module.exports = { _TV_ICM_Post, TVICMPostSchema };

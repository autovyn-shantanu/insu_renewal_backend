...
const _ItemsMst = function(sequelize, DataTypes) {
  return sequelize.define('ItemsMst', {
    UTD: {
      autoIncrement: true,
    ...
    indexes: [
      {
        name: "PK__ItemsMst__C5B6F0D2378853D7",
        unique: true,
        fields: [
          { name: "UTD" },
        ]
...
const itemsMstSchema = Joi.object({
...
module.exports = {_ItemsMst , itemsMstSchema};

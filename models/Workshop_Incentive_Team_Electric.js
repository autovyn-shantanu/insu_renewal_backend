...
const _WorkshopIncentiveTeamElectric = (sequelize) => {
  return sequelize.define('WorkshopIncentiveTeamElectric', {
    UTD: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'Workshop_Incentive_Team_Electric',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "PK_Workshop_Incentive_Team_Electric",
        unique: true,
        fields: [{ name: "UTD" }]
      }
    ]
...
const workshopIncentiveTeamElectricSchema = Joi.object({
...
module.exports = {_WorkshopIncentiveTeamElectric, workshopIncentiveTeamElectricSchema };

...
const _UserCloudActHst = function (sequelize, DataTypes) {
...
const UserCloudActHstSchema = Joi.object({
    USER_Code: Joi.number().integer().allow(null),

    Login_Batch: Joi.string().max(20).allow(null).allow(""),

    Action_Taken: Joi.string().max(500).allow(null).allow(""),
...
module.exports = { _UserCloudActHst, UserCloudActHstSchema };

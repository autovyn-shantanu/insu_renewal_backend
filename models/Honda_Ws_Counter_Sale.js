...
const _Honda_Ws_Counter_Sale = function (sequelize, DataTypes) {
    return sequelize.define('HondaWsCounterSale', {
        UTD: {
            autoIncrement: true,
        ...
        sequelize,
        tableName: 'Honda_Ws_Counter_Sale',
        schema: 'dbo',
        timestamps: false,
        indexes: [
            {
                name: "PK_Honda_Ws_Counter_Sale",
                unique: true,
                fields: [
                    { name: "UTD" },
                ],
...
const Honda_Ws_Counter_Sale_Shema = Joi.object({
...
module.exports = { _Honda_Ws_Counter_Sale, Honda_Ws_Counter_Sale_Shema };

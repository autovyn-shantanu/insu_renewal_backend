...
const _Labour_Analysis_Report = (sequelize) => {
  return sequelize.define('LabourBilling', {
    UTD: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'Labour_Analysis_Report',
    schema: 'dbo',
    timestamps: false,
    indexes: [
      {
        name: "PK_Labour_Analysis_Report",
        unique: true,
        fields: [{ name: "UTD" }]
      }
    ]
...
const _Labour_Analysis_ReportSchema = Joi.object({
...
module.exports = {_Labour_Analysis_Report,_Labour_Analysis_ReportSchema };

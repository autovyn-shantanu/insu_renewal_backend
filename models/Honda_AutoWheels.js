...
const _Honda_AutoWheels = function (sequelize, DataTypes) {
    return sequelize.define('Honda_AutoWheels', {
        UTD: {
            autoIncrement: true,
        ...
        sequelize,
        tableName: 'Honda_AutoWheels',
        schema: 'dbo',
        timestamps: false,
        indexes: [
            {
                name: "PK_Honda_AutoWheels",
                unique: true,
                fields: [
                    { name: "UTD" },
                ],
...
const Honda_AutoWheels_Shema = Joi.object({
    ...
    FrameNumber: Joi.string().max(30).allow(null, ""),
});
module.exports = { _Honda_AutoWheels, Honda_AutoWheels_Shema };
